...
.ChoiceOption {
	...
	&:focus {
		--focus-border:
			...
			0 0 0 3px var(--maker-color-neutral-20, #d3d3d3);
	}
...
.selected {
	...
	background-color: var(--selected-background-color, var(--maker-color-neutral-90, #1b1b1b));

	&:disabled {
		color: var(--selected-disabled-text-color, var(--maker-color-neutral-20, #d3d3d3));
	}
}
</style>
