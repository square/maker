...
.Label {
	margin-bottom: 16px;
	color: var(--color, var(--color-heading, inherit));
	font-weight: var(--fontWeight-heading, 500);
	font-size: 14px;
...
.Sublabel {
	color: var(--color, var(--color-text, inherit));
	font-weight: var(--fontWeight-body, inherit);
	font-size: 14px;
