...
| shape              | `string`  | —          | `squared`, `rounded`, `pill`, `'Npx'`, `'N%'` | Shape of button                                                                            |
| shape-hover        | `string`  | —          | `'Npx'`, `'N%'`                               | Shape of button                                                                            |
...
| box-shadow         | `string`  | —          | —                                             | Box-shadow of button (e.g. 0px 0px 1px 3px #000000 or 0px 0px 1px 3px rgba(0, 0, 0, 0.5))  |
