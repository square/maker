...
| ---------- | ----------- | ------- | --------------- | ------------------------------------------------------------------------------------- |
| v-model    | `undefined` | —       | —               | if truthy or equal to expandKey the accordion will expand, otherwise it will collapse |
| expand-key | `undefined` | —       | —               | used to orchestrate the collapsing & expanding of multiple accordions                 |
